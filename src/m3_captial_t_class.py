...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        self.h_rect = rg.Rectangle(rg.Point(self.center.x - width / 2, self.center.y - letter_thickness / 2),rg.Point(self.center.x + width / 2, self.center.y + letter_thickness / 2))
        self.vertical_top_corner = rg.Point(self.center.x - letter_thickness / 2, self.center.y - letter_thickness / 2)
        self.vertical_bottom_corner = rg.Point(self.center.x + letter_thickness / 2,self.center.y + height - letter_thickness / 2)
        self.v_rect = rg.Rectangle(self.vertical_top_corner,self.vertical_bottom_corner)
